...
function sessionsToQueue(url, publicKey){
    ...
    if (enteredKeysPairingsDict){
        if (publicKey in enteredKeysPairingsDict){
            window.location.href = url+"session.html";
...
function onLoadSessions(){
    ...
    // Get the button that opens the modal
    let btn = document.getElementById("sessionCreateBtn");
    ...
    // Get the modal
    let modal2 = document.getElementById("keyModal");

    // Get the button that opens the modal
    let btn2 = document.getElementById("keyBtn");
